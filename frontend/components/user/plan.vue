<template>
  <view class="content">
    ...
    <view class="input" v-if="choice">
      <view class="input1">
        <text style="color: #505050;font-size: 40rpx;">目标体重:</text><input :value="targetweight" type="number"
          :placeholder="targetweight" maxlength="3" @input="set" /><text style="color: #505050;font-size: 40rpx;">KG</text>
      </view>
      <view class="input2">
        <text style="color: #505050;font-size: 40rpx;">所用天数:</text><input :value="day" type="number" maxlength="4"
          :placeholder="day" @input="changedate" /><text style="color: #505050;font-size: 40rpx;">Day</text>
      </view>
    </view>
